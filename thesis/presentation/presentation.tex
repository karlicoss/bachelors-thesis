...
\frametitle{Использование квантовых точек для получения нелинейных эффектов (продолжение)}
\begin{figure}
\includegraphics[width=0.8\textwidth]{transmission_2_3-1-2_0.png}
...
\frametitle{Использование квантовых точек для получения нелинейных эффектов (продолжение)}
\begin{figure}
\includegraphics[width=0.8\textwidth]{pdensity_18_4.png}
...
\frametitle{Использование квантовых точек для получения нелинейных эффектов (продолжение)}
\begin{figure}
\includegraphics[width=0.8\textwidth]{pdensity_19_0.png}
...
## Получаем ограничения на коэффициенты $\alpha_W, \alpha_R$ перед дополнительными элементами, они задают однопараметрическое семейство расширений
## Но эти расширения отличаются друг от друга на комплексную фазу $e^{it}$, и физически эквивалентны
\end{easylist}
\end{frame}
