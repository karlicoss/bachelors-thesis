...
\begin{easylist}[itemize]
# Заменим конечное отверстие на точечное, получаем \textit{аппроксимацию} модели с конечным отверстием моделью с отверсием нулевого радиуса
...
\begin{easylist}[itemize]
# Сузим область определния оператора Лапласа $\Delta$ до функций, зануляющихся в окрестности точечного отверстия
...
\begin{figure}
\includegraphics[width=0.6\textwidth]{pdensity_18_4.png}
\caption{Волновая функция в резонансной точке}
\end{figure}
\begin{figure}
\includegraphics[width=0.6\textwidth]{pdensity_19_0.png}
...
\begin{figure}
\includegraphics[width=0.8\textwidth]{transmission.png}
