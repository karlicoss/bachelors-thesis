...
Функция Грина для одномерной потенциальной ямы $[a; b]$ имеет замкнутый вид: \todo{Забыл про константу $\frac{1}{2}$ перед Лапласианом, кажется}
...
\begin{align*}
& D(x, y) = \eval{\pdv{G_R(x, y, x_s, y_s; E)}{y}}_{x_s = \frac{L_x}{2}, y_s = 0} \\
